...
public class b_beautician extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bbeautician);
        ...
        b1 = findViewById(R.id.beautybtn);

        backp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                b_beautician.super.onBackPressed();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference node = db.getReference("Beauticians");
