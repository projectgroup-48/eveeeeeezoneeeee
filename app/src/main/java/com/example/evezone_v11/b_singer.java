...
public class b_singer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bsinger);
        ...
        b1 = findViewById(R.id.singbtn);

        backp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                b_singer.super.onBackPressed();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference node = db.getReference("Singers");
