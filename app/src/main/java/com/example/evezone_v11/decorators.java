...
public class decorators extends AppCompatActivity {
...
//                Toast.makeText(dancers.this, "into onDataChange" + dataSnapshot.getKey(), Toast.LENGTH_SHORT).show();
                for (DataSnapshot dateSnapshot: dataSnapshot.getChildren()) {
                    ...
                    User u = new User();
                    decorators.this.list.add(new User(s.getBcity(),name,s.getBlink(),s.getBcontact(),s.getBrate(),s.getBprof(),s.getBexp()));

                }
//                Toast.makeText(dancers.this, list +" ", Toast.LENGTH_SHORT).show();
                myAdapter = new MyAdapter(decorators.this,list);
        ...
        backp.setOnClickListener(view -> decorators.super.onBackPressed());
