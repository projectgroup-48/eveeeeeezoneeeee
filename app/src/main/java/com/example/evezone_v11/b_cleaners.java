...
public class b_cleaners extends AppCompatActivity {
    ImageView backp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bcleaners);
        ...
        b1 = findViewById(R.id.clnbtn);

        backp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                b_cleaners.super.onBackPressed();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference node = db.getReference("Cleaners");
