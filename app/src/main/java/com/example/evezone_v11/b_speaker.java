...
public class b_speaker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bspeaker);
        ...
        b1 = findViewById(R.id.spbtn);
        backp = findViewById(R.id.back3);

        backp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                b_speaker.super.onBackPressed();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference node = db.getReference("Speakers");
