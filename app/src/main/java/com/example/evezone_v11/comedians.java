...
public class comedians extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comedians);

        list = new ArrayList<User>();
        backp = findViewById(R.id.back);
        recyclerView =  findViewById(R.id.recyclerView);
        DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
        db = rootRef.child("Comedians");
...
//                Toast.makeText(dancers.this, "into onDataChange" + dataSnapshot.getKey(), Toast.LENGTH_SHORT).show();
                for (DataSnapshot dateSnapshot: dataSnapshot.getChildren()) {
                    ...
                    User u = new User();
                    comedians.this.list.add(new User(s.getBcity(),name,s.getBlink(),s.getBcontact(),s.getBrate(),s.getBprof(),s.getBexp()));

                }
//                Toast.makeText(dancers.this, list +" ", Toast.LENGTH_SHORT).show();
                myAdapter = new MyAdapter(comedians.this,list);
        ...
        backp.setOnClickListener(view -> comedians.super.onBackPressed());
